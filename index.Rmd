...
prob_lowELA = exp(beta0+beta1math*math + beta1ela*lowELA + beta2*math*lowELA)/(1+exp(beta0+beta1math*math + beta1ela*lowELA + beta2*math*lowELA))
prob_medELA = exp(beta0+beta1math*math + beta1ela*medELA + beta2*math*medELA)/(1+exp(beta0+beta1math*math + beta1ela*medELA + beta2*math*medELA))
prob_highELA = exp(beta0+beta1math*math + beta1ela*highELA + beta2*math*highELA)/(1+exp(beta0+beta1math*math + beta1ela*highELA + beta2*math*highELA))


par(cex.axis=1.25, cex.lab=1.5)
matplot(x = cbind(math,math,math), y = cbind(prob_lowELA, prob_medELA, prob_highELA), type="l", xlab = "Math Score", ylab="Probability of Correct Response", col=2:4, lwd=5)
legend(x = -4, y = 1, legend = c("Low ELA Score", "Average ELA Score", "High ELA Score"), col = 2:4, lwd = 5)
```
</details>
</div>
...
a = 1.5
b = -1
prob = exp(a*(theta-b))/(1+exp(a*(theta-b)))
par(cex.axis=1.25, cex.lab=1.5)
plot(x = theta, y = prob, type="l", xlab = "Score", ylab="Probability of Correct Response", col=2, lwd=5)
...
prob = c(.15, .90)
par(cex.axis=1.25, cex.lab=1.5)
barplot(prob, ylim=c(0,1), xlab="Status", col=2, ylab="Probability of Correct Response", names.arg=c("Non Master", "Master"))
```
...
prob = c(.15, .3, .4, .95)
par(cex.axis=1.25, cex.lab=1.5)
barplot(prob, ylim=c(0,1), xlab="Status", col=2, ylab="Probability of Correct Response", names.arg=c("NM; NM", "NM; M", "M, NM", "M; M")) 
```
